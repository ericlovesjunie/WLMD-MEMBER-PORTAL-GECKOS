  ...
  <body>
    ...
    <div style="position: relative">
      ...
      <div
        ...
        style="position: relative; min-height: 90vh; padding-top: 80px"
      >
        <div class="payment-content">
          <div class="payment-header_p">
            <p class="paymen_p_tag" style="font-size: 20px">
              Your card is declined, please try with another card
            </p>
          </div>
          <div class="payment-content2">
            <div class="checkout-form">
              <div class="payment_card">
                <div class="payment_card_titel">
                  <b
                    ><img
                      src="{{ URL::asset('public/assets/aniket_logo/credit-card.png') }}"
                      class="titel_img"
                      alt=""
                    />Payment Methods</b
                  >
                  <div class="card_icon_div">
                    <img src="{{ URL::asset('public/assets/aniket_logo/visa.svg') }}" class="item_img_card" alt="Visa" />
                    <img
                      src="{{ URL::asset('public/assets/aniket_logo/master.svg') }}"
                      class="item_img_card"
                      alt="MasterCard"
                    />
                    <img src="{{ URL::asset('public/assets/aniket_logo/jcb.svg') }}" class="item_img_card" alt="JCB" />
                    <img
                      src="{{ URL::asset('public/assets/aniket_logo/american.svg') }}"
                      class="item_img_card"
            ...
            <div class="order-summary">
              ...
              <div class="details_order">
                <p>
                  <img src="{{ URL::asset('public/assets/aniket_logo/check.png') }}" class="check_img" alt="" /> Provider &
                  Medication Included
                </p>
                <p>
                  <img src="{{ URL::asset('public/assets/aniket_logo/check.png') }}" class="check_img" alt="" /> On Demand
                  Virtual Doctor Visits
                </p>
                <p>
                  <img src="{{ URL::asset('public/assets/aniket_logo/check.png') }}" class="check_img" alt="" /> 30 Days
    ...
    //   const user_id = getQueryParam("user_id");
      ...
      async function completeCheckout(token) {
        ...
        checkout_api(token, user_id);
      }

      // const checkout_api = async (token, user_id) => {
      //   const data1 = {
      //     payment_token: token,
      //     user_id: user_id,
      //   };
      ...
      //       "https://lightgoldenrodyellow-okapi-586794.hostingersite.com/gettrim/api/update_payment_token",
      //       {
      //         method: "POST",
      ...
      //     // 3-second delay for loader effect
      ...
      const checkout_api = async (token, user_id) => {
        ...
        try {
          ...
          // Process the response normally if it's not a 400 status
          const data = await response.json();
          ...
          // Check response status from the API response body
          if (data.status == 0) {
            alert(data.message);
            location.reload();
            return;
            ...
            //   "https://gokulnair.com/jalpesh/checkout_page/SuccessPage.html";
              "https://lightgoldenrodyellow-okapi-586794.hostingersite.com/gettrim/add_order";
            console.log("res", data);
          }
        } catch (error) {
    ...
    <script>
      // window.onload = async function fetchProductDetails() {
      document.addEventListener(
        ...
        async function fetchProductDetails() {
          ...
          try {
            const response = await fetch(
              "https://lightgoldenrodyellow-okapi-586794.hostingersite.com/gettrim/api/get_product_details",
              {
                method: "POST",
                headers: {
                  "Content-Type": "application/json",
            ...
            if (data.status === 1 && data.product_data) {
              ...
              document.getElementById("grand-total-price").innerText =
                priceText; // Set price for grand total
            } else {
