                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- </td> --}}
                                        <td>
                                            {{-- <a href="{{ url('add_new_order', $data->product_id) }}" class="btn btn-primary shadow btn-xs sharp me-1">Place Order</a> --}}
                                        {{-- <a href="#" class="btn btn-danger shadow btn-xs sharp"><i
                                                class="fa fa-trash"></i></a> --}}

                                                <a href="{{ url('add_new_order', $data->product_id) }}">
                                                    <button type="button" class="btn btn-primary" value="aa" data-toggle="modal" data-target="#" style="float:;">Place Order</button>
                                                </a> 
                                        </td>
