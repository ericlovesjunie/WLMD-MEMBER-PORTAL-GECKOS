<link rel="stylesheet" href="{{ URL::asset('public/assets/vendor/fonts/remixicon/remixicon.css') }}" />
<!DOCTYPE html>
<html lang="en">
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
    ...
    <link href="{{ URL::asset('public/assets/vendor/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('public/assets/vendor/jquery-nice-select/css/nice-select.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('public/assets/vendor/owl-carousel/owl.carousel.css') }}" rel="stylesheet">
    <!-- Style css -->
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="{{ url('home') }}" class="brand-logo">
                ...
                @if($theme)
                <img src="{{ URL::asset('public/assets/theme_logo/' . $theme->theme_logo) }}" alt="Linda Miller" class="img-fluid">
                @else
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ url('category') }}" class="" aria-expanded="false">
                            <i class="flaticon-381-heart"></i>
                            <span class="nav-text">Category</span>
                        </a>
                    </li>

                    <li><a href="{{ url('site') }}" class="" aria-expanded="false">
                        <i class="flaticon-381-heart"></i>
                        <span class="nav-text">Site</span>
                    </a>
                </li>

                    <li><a href="{{ url('product') }}" class="" aria-expanded="false">
                            <i class="fas fa-user-check"></i>
                            <span class="nav-text">Product</span>
                        </a>
                    </li>
                    <li><a href="{{ url('user') }}" class="" aria-expanded="false">
                            <i class="flaticon-381-user-7"></i>
                            <span class="nav-text">User</span>
                        </a>
                    </li>
                    <li><a href="{{ url('patients') }}" class="" aria-expanded="false">
                            <i class="la la-users"></i>
                            <span class="nav-text">MDI Patients</span>
                        </a>
                    </li>
                    <li><a href="{{ url('webhook') }}" class="" aria-expanded="false">
                            <i class="flaticon-381-heart"></i>
                    ...
                    <li><a href="{{ url('cases') }}" class="" aria-expanded="false">
                        <i class="fas fa-clone"></i>
                        <span class="nav-text">cases</span>
                    </a>

                    {{-- <li><a href="{{ url('add_order') }}" class="" aria-expanded="false">
                        <i class="fas fa-clone"></i>
                        <span class="nav-text">Weight Loss Order</span>
                    </a>
                </li> --}}
                @if ($is_admin == 1 )
                <li><a href="{{ url('theme_colore') }}" class="" aria-expanded="false">
                    <i class="fas fa-clone"></i>
                    <span class="nav-text">Theme Colore</span>
                </a>
                @endif
                </li>
                    <li><a class="dropdown-item" href="{{ url('logoutadmin') }}">
